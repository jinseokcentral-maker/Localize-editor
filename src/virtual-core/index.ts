...
> {
  ...
  private maybeNotify = memo(
    ...
    {
      key: import.meta.env.DEV && 'maybeNotify',
  ...
  private getMeasurements = memo(
    ...
    {
      key: import.meta.env.DEV && 'getMeasurements',
      debug: () => this.options.debug,
    },
  )
  ...
  calculateRange = memo(
    ...
    {
      key: import.meta.env.DEV && 'calculateRange',
      debug: () => this.options.debug,
    },
  )
  ...
  getVirtualIndexes = memo(
    ...
    {
      key: import.meta.env.DEV && 'getVirtualIndexes',
      debug: () => this.options.debug,
    },
  )
  ...
  resizeItem = (index: number, size: number) => {
    ...
    if (delta !== 0) {
      if (
        ...
        if (import.meta.env.DEV && this.options.debug) {
  ...
  getVirtualItems = memo(
    ...
    {
      key: import.meta.env.DEV && 'getVirtualItems',
      debug: () => this.options.debug,
    },
  )
